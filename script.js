...
mode.addEventListener('click', (event) => {
    ...
    if (event.target.classList.contains('light')) {
        ...
        // document.querySelectorAll('.bubbles').style.backGround='linear-gradient(45deg,rgba(255,255,255,0.4),hotpink,red,rgba(255,255,255,0.2)'
        ...
        document.getElementById('title').style.color = "hotpink";
        document.getElementById('btn').style.backgroundColor = 'hotpink';
